...
This was overcome by simply modifying the ***CountIf*** function to include those potentially omitted results with a "greater than or equal to" formula instead of just a "greater than" formula.  By doing so we ensured that all data gathered in the study was included in the analysis.
